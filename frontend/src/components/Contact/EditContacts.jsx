...
/**
 * Formulaire d'édition des contacts (Mode Édition)
 */
  ...
  return (
    <div className="space-y-6">
      <EditSection
        title="Directeur"
        data={data.directeur}
        onChange={(field, value) => handleChange("directeur", field, value)}
      />

      <EditSection
        title="Secrétaire"
        data={data.secretaire}
        onChange={(field, value) => handleChange("secretaire", field, value)}
      />
